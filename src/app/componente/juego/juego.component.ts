...
export class JuegoComponent {
  ...
  nuevoPunto(data:number){
    ...
    } else if (this.puntos1>3 && this.puntos1-this.puntos2 >=2 && this.puntuacion1=="Ventaja") {
    ...
    } else if (this.puntos2 > 3 && this.puntos2-this.puntos1 >= 2 && this.puntuacion2=="Ventaja") {
